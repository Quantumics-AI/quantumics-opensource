...
public class QsConstants {
  ...
  public static final String QS_LIVY_TEMPLATE_NAME = "etl_livy_template.py";
  ...
  public static final String FILE_QUALITY_CHECK_PYTHON_FILE_REL_LOC = "ai/quantumics/ml/Data_Quality_Check.py";
  public static final String COLUMN_VAL_FREQ_PYTHON_FILE_REL_LOC = "ai/quantumics/ml/Column_Value_Freq.py";
  public static final String FILE_QUALITY_CHECK_INV_PYTHON_FILE_REL_LOC = "ai/quantumics/ml/Data_Quality_Check_Invalid_Values.py";
  public static final String PII_COL_DETECTION_PYTHON_FILE_REL_LOC = "ai/quantumics/ml/PII_Column_Detection.py";
  public static final String QS_LIVY_TEMPLATE_ENG_NAME = "etl_livy_template_eng.py";
  ...
  public static final String SUB_USER_SIGNUP = "SUB_USER_SIGNUP";
  public static final String SUBMIT_CONSENT = "SUBMIT_CONSENT";
  ...
  public static final String SUBMIT_CONSENT_SUBJECT = "Quantumics: Consent Accepted";

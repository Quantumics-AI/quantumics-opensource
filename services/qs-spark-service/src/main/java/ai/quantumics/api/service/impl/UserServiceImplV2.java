...
import ai.quantumics.api.repo.UserConsentRepository;
import ai.quantumics.api.repo.UserRepositoryV2;
...
public class UserServiceImplV2 implements UserServiceV2 {
  ...
  public QsUserConsent saveUserConsent(QsUserConsent qsUserConsent) {
    return userconsentRepository.saveAndFlush(qsUserConsent);
  }

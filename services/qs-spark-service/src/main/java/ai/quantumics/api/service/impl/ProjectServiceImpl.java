...
public class ProjectServiceImpl implements ProjectService {
  ...
  @Override
  public Projects getDefaultProjectForUser(final int userId) throws SQLException {
    final Optional<Projects> project = projectRepo.findByUserIdAndMarkAsDefaultTrue(userId);
  ...
  public boolean isExists(String projectName) {
    return projectRepo.existsByProjectNameAndActiveTrue(projectName);
  }

...
@Component({
  selector: 'app-view-ingest-pipeline',
  templateUrl: './view-ingest-pipeline.component.html',
  styleUrls: ['./view-ingest-pipeline.component.scss']
})
export class ViewIngestPipelineComponent implements OnInit {
  ...
  sourceData(folderId, folderName) {
    // this.router.navigate([`projects/${this.projectId}/ingest/pipelines/dataset/${this.folderId}/${this.folderId}`]);

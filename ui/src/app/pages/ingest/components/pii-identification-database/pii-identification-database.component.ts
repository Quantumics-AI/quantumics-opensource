...
@Component({
  selector: 'app-pii-identification-database',
  templateUrl: './pii-identification-database.component.html',
  styleUrls: ['./pii-identification-database.component.scss']
})
export class PiiIdentificationDatabaseComponent implements OnInit {
  ...
  public continue(): void {
    ...
    this.router.navigate([`projects/${this.projectId}/ingest/database-completion/${this.sourceType}`]);

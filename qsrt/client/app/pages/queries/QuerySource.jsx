...
function QuerySource(props) {
  ...
  const clearQueryEditor = useCallback(() => {
    if (editorRef.current) {
        ...
        <Resizable direction="horizontal" sizeAttribute="flex-basis" toggleShortcut="Alt+Shift+D, Alt+D">
          <nav>
            ...
            <div  className="editor__left__schema">
              ...
              {
                dataSource && dataSource.type != 'athena' &&
                <SchemaBrowser
                schema={schema}
              ...
              /> }
              {
                dataSource && dataSource.type == 'athena' && <FileExplorer onItemSelect={handleSchemaItemSelect} />
              }
            ...
            <div
              ...
              style={{ left: 0, top: 0, right: 0, bottom: 0, overflow: "auto" }}>
                  ...
                  {/* <ul>
                    ...
                    <li>SELECT column1, column2, column3 FROM tablename WHERE columnx = 'value'  </li>
                  </ul> */}

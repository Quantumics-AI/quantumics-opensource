...
#modified for db filtering added dbname param
    def __get_schema_from_glue(self,dbname):
...
#modified for db filtering added dbname param
    def get_schema(self, dbname,get_stats=False):
        if self.configuration.get("glue", False):
            return self.__get_schema_from_glue(dbname)
